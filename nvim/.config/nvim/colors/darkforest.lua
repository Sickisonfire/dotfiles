...
set_hl("DiagnosticError", { fg = palette["red"], bg = NONE, italic = true })
set_hl("DiagnosticWarn", { fg = palette["yellow"], bg = NONE, italic = true })
set_hl("DiagnosticInfo", { fg = palette["blue"], bg = NONE, italic = true })
set_hl("DiagnosticHint", { fg = palette["grey-light"], bg = NONE, italic = true })
set_hl("DiagnosticOk", { fg = palette["green"], bg = NONE, italic = true })
set_hl("DiagnosticUnderlineError", { fg = palette["red"], bg = NONE, undercurl = true })
set_hl("DiagnosticUnderlineWarn", { fg = palette["yellow"], bg = NONE, undercurl = true })
set_hl("DiagnosticUnderlineInfo", { fg = palette["blue"], bg = NONE, undercurl = true })
set_hl("DiagnosticUnderlineHint", { fg = palette["grey-light"], bg = NONE, undercurl = true })
set_hl("DiagnosticUnderlineOk", { fg = palette["green"], bg = NONE, undercurl = true })
...
set_hl("CursorLineNr", { fg = palette["green"], bg = palette["grey-dark"], bold = true })
...
set_hl("PmenuSbar", { bg = palette["black"] })
set_hl("PmenuThumb", { bg = palette["cyan-dark"] })
set_hl("PmenuSel", { fg = palette["black"], bg = palette["green"], bold = true })
...
-- cmd('syntax keyword Todo    TODO FIXME    contained')
-- cmd('syntax match   Comment "//.*"  contains=Todo')
